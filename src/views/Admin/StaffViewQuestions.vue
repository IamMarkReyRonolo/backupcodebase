...
<script>
	import HeaderSectionVue from "../../components/StaffComponents/ViewQuestionsComponents/HeaderSection.vue";
	import ResultsSectionVue from "../../components/StaffComponents/ViewQuestionsComponents/ResultsSection.vue";
