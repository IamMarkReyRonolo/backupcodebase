<template>
	<div>
		...
		<div class="field">
			...
			<div class="select">
				<v-text-field
					filled
					dense
					v-model="questionStore.updatedQuestion.metadata.teks_code"
					:rules="teksCodeRules"
					counter="6"
					id="setTeksCode"
				></v-text-field>
		...
		<div class="field">
			...
			<div class="select">
				<v-combobox
					v-model="questionStore.updatedQuestion.metadata.subject"
					:items="subjects"
					filled
					dense
					color="#4c5b77"
		...
		<div class="field">
			...
			<div class="select">
				<v-combobox
					v-model="questionStore.updatedQuestion.metadata.topic"
					:items="topics"
					filled
					dense
					color="#4c5b77"
		...
		<div class="field">
			...
			<div class="select">
				<v-combobox
					v-model="questionStore.updatedQuestion.metadata.category"
					:items="categories"
					filled
					dense
					color="#4c5b77"
		...
		<div class="field">
			...
			<div class="select">
				<v-combobox
					v-model="questionStore.updatedQuestion.metadata.keywords"
					:items="keywords"
					multiple
					filled
					dense
		...
		<div class="field">
			...
			<div class="select">
				<v-select
					filled
					dense
					v-model="questionStore.updatedQuestion.metadata.difficulty"
					:items="difficulty"
					:rules="required"
					id="setDifficulty"
				></v-select>
		...
		<div class="field">
			...
			<div class="select">
				<v-text-field
					filled
					dense
					v-model="questionStore.updatedQuestion.metadata.points"
					type="number"
	...
	export default {
		created() {
			...
			this.gradeLevels.forEach((level) => {
				if (
					level.level == this.questionStore.updatedQuestion.metadata.grade_level
				) {
					level.selected = true;
					hasSelected = true;
				} else {
			...
			if (!hasSelected) {
				...
				this.questionStore.updatedQuestion.metadata.grade_level =
			...
			select(gLevel) {
				this.gradeLevels.forEach((l) => {
					if (l.level == gLevel.level) {
						l.selected = true;
						this.questionStore.updatedQuestion.metadata.grade_level = l.level;
					} else {
						l.selected = false;
					}
				});
