				...
				<div class="questionContent" v-if="!reset">
					...
					<div class="addImgCon">
						<div class="imgPresent">
							<div
								class="imgContainer"
								v-if="questionStore.updatedQuestion.question_img != ''"
							>
								<img
									:src="questionStore.updatedQuestion.question_img"
									alt=""
									v-if="questionStore.updatedQuestion.question_img != ''"
								/>
							</div>
							...
							<div style="text-align: center">
								...
								>
									...
									<v-btn
										...
										@click="questionStore.updatedQuestion.question_img = ''"
		...
		methods: {
			...
			imageFile(file) {
				...
				if (files.length == 0) {
					...
					reader.onloadend = () => {
						this.questionStore.updatedQuestion.question_img = reader.result;
					};
				}
			},
